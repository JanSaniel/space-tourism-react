...
const Navbar = () => {
  ...
  return (
    ...
    <div className='max-w-[1440px] flex  items-center justify-between mx-auto 
                    md:pt-4 md:pl-4 ts:pt-0'>
      <a href="/" class="flex items-center ml-5 mt-5 ts:ml-7 ts:mt-1 md:mt-5">
      ...
      <div className=" hidden
        ...
        <ul className="font-barlowCondensed flex bg-white bg-opacity-[4%] backdrop-blur-md
         ...
         <li>
            <a href="/" className="block  text-white w-full shrink-0
                                   md:bg-transparent md:p-4 
                                   relative cursor-pointer transition-all duration-500 
                                   before:content-[''] before:absolute before:left-0 before:w-full before:h-[4px]  before:opacity-100 before:duration-500 before:bg-white
                                   md:before:-bottom-2 
                                   ts:before:-bottom-6" >00 HOME</a></li>
          <li>
            <a href="/" className="block  text-white 
                                   ...
                                   md:before:-bottom-2 
                                   ts:before:-bottom-6">01 DESTINATION</a></li>
          ...
          <li>
            <a href="/" className="block text-white 
                                   ...
                                   hover:before:w-full hover:before:opacity-100
                                   md:before:-bottom-2
                                   ts:before:-bottom-6">02 CREW</a></li>
          <li>
            <a href="/" className="block text-white 
                                   md:bg-transparent md:p-4 
                                   relative cursor-pointer transition-all duration-500 
                                   ...
                                   hover:before:w-full hover:before:opacity-100
                                   md:before:-bottom-2
                                   ts:before:-bottom-6" >03 TECHNOLOGY</a></li>
          </ul>
      </div>
