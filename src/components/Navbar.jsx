...
const Navbar = () => {
  ...
  return (
    ...
    <div className='flex w-full items-center justify-between mx-auto 
        ...
        <hr className="fs:h-px fs:z-20 fs:mr-[-2rem] fs:ml-[13rem] fs:my-8 fs:w-[50rem] fs:mt-[60px] fs:bg-gray-200 fs:border-0"/>  
        <div className="hidden
            ...
            <ul className="font-barlowCondensed flex bg-white bg-opacity-[4%] backdrop-blur-md
                           ...
                           ts:text-[18px]  ts:flex-row ts:space-x-8 ts:items-center ts:w-[450px] ts:pl-10 ts:h-[96px]
                           fs:w-full">
                <li>
      ...
      <div onClick={handleNav} className='block z-10  mr-5 mt-3 md:hidden ts:hidden fs:hidden'>
      ...
      <ul className={nav ?' fixed md:hidden ts:hidden  font-barlowCondensed text-[18px] right-0 top-[0] w-[254px] h-full border-r border-r-gray-900 bg-white bg-opacity-[4%] backdrop-blur-[50px] ease-in-out duration-500'
                         :'fixed font-barlowCondensed text-[18px] top-[0] w-[254px] h-full border-r border-r-gray-900 bg-white bg-opacity-[4%] backdrop-blur-[50px] ease-in-out duration-500  right-[-100%] '}>
